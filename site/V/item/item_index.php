    ...
    <div class="home-view">
        <div class="item-widget">
            <fieldset>
                ...
                <p id="sale"><?=$data->name?> <p class="item-date"><?=$data->updated_date?></p></p>
                <div>
...
?>
                        ...
                        <section class="regular slider">
                            <div>
                                <img src="<?=ASSETS?>default/files/<?=$data->image?>" data-toggle="pill"
                                    href="#main-image">
                            </div>
...
if (!empty($data->other_image)) {
    ...
    foreach ($images as $index => $image) {
        ?>
                            <div>
                                <img src="<?=ASSETS?>default/files/<?=$image?>" data-toggle="pill"
                                    href="#image_<?=$index?>">
                            </div>
                            <?php
}}
?>
                    ...
                    <div class="plot-image-right">
                        ...
                        <div id="plots">
                            ...
                            <div id="divbody">
                                <p class="<?=IsTrue($data->phone, null, 'hide')?>"><span class="fa fa-phone"></span>
                                    <?=$data->phone?></p>
                                <p class="<?=IsTrue($data->email, null, 'hide')?>"><span
                                        class="fa fa-envelope"></span><?=$data->email?></p>
                            </div>
                        </div>
                        <div id="plots">
                            <div id="divheader">Status</div>
                            <div id="divbody">
                                <p id="Status"><span class="glyphicon glyphicon-ok"
                                        style="color: green;font-size: 35sspx;"></span> Available</p>
                            </div>
                        </div>
                        <div id="plots">
                        ...
                        <button class="btn btn-primary" data-toggle="modal" data-target="#contact-modal">Contact
                            Us</button>
                            ...
                            <div class="modal-dialog modal-md" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form method="POST" action="<?=LINK?>item/contact"
                                            @submit.prevent="ContactUs($event)">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="site-form-control">
                                                        ...
                                                        <div class="alert alert-success" v-if='notification != null'
                                                            v-html='notification'></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
