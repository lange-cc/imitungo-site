                        ...
                        <form  @submit.prevent="LoginUser" method="post" action="#">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="*****************" name="password" v-model="credentials.password">
                                    <?=$this->Auth()?>
                      ...
                      <span class="input-group-text">
                        <i class="mdi mdi-check-circle-outline"></i>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="*****************" name="re_password" v-model="credentials.re_password">
                                    <div class="input-group-append">
                      <span class="input-group-text">
                        <i class="mdi mdi-check-circle-outline"></i>
                      </span>
