            ...
            <div class="row w-100">
                <div class="col-lg-3 mx-auto">
                    <div class="auto-form-wrapper">
                        <h4>Do you forget your password?</h4>
                        <form  @submit.prevent="LoginUser" method="post" action="#">
                            <div class="form-group">
                                <label class="label">Enter your email</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="example@everything.rw" name="username" v-model="credentials.email">
                                    <?=$this->Auth()?>
                      ...
                      <span class="input-group-text">
                        <i class="mdi mdi-check-circle-outline"></i>
                            ...
                            <div class="form-group d-flex justify-content-between">
                                <div>
                                    <label class="form-check-label" style="font-size: 10px;font-weight: 800;">
                                      After submit your email we will send a link which will help you to change your password.
                                    </label>
                                </div>

                            </div>
                            <a href="<?=LINK?>login/" class="btn btn-dark btn-fw">Back</a>
                        </form>
                    </div>
